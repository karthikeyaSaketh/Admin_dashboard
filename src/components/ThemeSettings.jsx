    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen
        ...
        <div className='flex-col border-t-1 p-4 ml-4'>
          <p className='font-semibold text-lg dark:text-gray-400'>Theme Options</p>
          <div className='mt-4'>
            <input type='radio' id='light' name="theme" value="Light" className='cursor-pointer' onChange={setMode} checked={currentMode==='Light'} />
            <label htmlFor='light' className='ml-2 text-md cursor-pointer dark:text-gray-400'>Light</label>
          </div>
          <div className='mt-4'>
            <input type='radio' id='dark' name="theme" value="Dark" className='cursor-pointer' onChange={setMode} checked={currentMode==='Dark'} />
            <label htmlFor='dark' className='ml-2 text-md cursor-pointer dark:text-gray-400'>Dark</label>
          </div>
        </div>
        <div className='flex-col border-t-1 p-4 ml-4'>
          <p className='font-semibold text-lg dark:text-gray-400'>Theme Colors</p>
