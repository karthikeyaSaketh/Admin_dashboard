  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center" style={{ backgroundImage: "url(https://flexy-react-stylish.netlify.app/assets/welcome-bg2-2x-svg-14e3163f.svg)", backgroundSize: "50%", backgroundRepeat: " no-repeat", backgroundOrigin: " content-box", backgroundPositionX: " right", backgroundPositionY: "top" }}>
          <div className="flex justify-between items-center">
            <div>
              <p className='font-bold text-gray-400'>Earnings</p>
              <p className='text-2xl'>$12345.67</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          <div className='flex justify-between'>
            ...
            <div className='flex items-center gap-4'>
              <p className='flex items-center text-gray-600 gap-2 hover:drop-shadow-xl'>
                <span><FaCircle className='w-3 h-3' /></span>
                <span>Expense</span>
              </p>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$23242</span>
